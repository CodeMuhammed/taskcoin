...
(function(window , document){
    ...
    var Taskcoin = ensure(window , 'Taskcoin' , function(){
        ...
        var initialize = function(options){
              (function(){
                   var taskcoin = '<div id="taskcoin" class="col-xs-12" style="width:100%;height:100%;padding:0;position:fixed;background-color:rgba(0,0,0,.5);z-index:100000000000000">'+
